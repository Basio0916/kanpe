  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-border">
        <h2 className="text-sm font-semibold text-foreground">{d.settingsTitle}</h2>
        {onClose && (
          <button
            onClick={onClose}
      ...
      <div className="flex flex-1 min-h-0">
        {/* Sidebar */}
        <div className="flex w-48 shrink-0 flex-col border-r border-border bg-secondary/30 py-2 overflow-y-auto">
