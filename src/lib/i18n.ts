...
const en = {
  ...
  sttDesc: "Change speech recognition settings.",
  sttProvider: "Provider",
  sttProviderDesc: "Speech recognition backend",
  connectedStatus: "Ready",
  model: "Model",
  modelDesc: "STT model to use",
...
const ja: Record<DictKeys, string> = {
  ...
  // STT settings
  sttSettings: "STT 設定",
  sttDesc: "音声認識の設定を変更します。",
  sttProvider: "プロバイダー",
  sttProviderDesc: "音声認識バックエンド",
  connectedStatus: "準備完了",
  model: "Model",
  modelDesc: "使用するSTTモデル",
  languageLabel: "Language",
